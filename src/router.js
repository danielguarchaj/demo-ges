...
export default new Router({
  routes: [
    {
      path: "/",
      redirect: "/material-clase",
      component: () => import("@/view/layout/Layout"),
      children: [
        {
          path: "/material-clase",
          name: "material-clase",
          component: () => import("@/view/pages/MaterialClase.vue")
        },
        {
          path: "/indice-evaluaciones",
          name: "indice-evaluaciones",
          component: () => import("@/view/pages/IndiceEvaluaciones.vue")
        },
        {
          path: "/asignaciones",
          name: "asignaciones",
          component: () => import("@/view/pages/Asignaciones.vue")
        },
        {
          path: "/builder",
          name: "builder",
