...
<template>
  <b-modal id="modal-agregar-tarea" size="xl" @ok="handleOk">
    <template #modal-header="{ close }">
      <h5>{{ action }} {{ selectedModal }}</h5>
    </template>
    <template>
      <div class="d-flex justify-content-end">
        <p class="text-right">
          Si desea agregar asignaciones en varias clases o secciones seleccione
          la opción que se encuentra
          <br />
        ...
        <div class="col-xl-9">
          ...
          <div class="form-group row form-element">
            ...
            <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic">
              ...
              <span class="form-text text-muted">
                <i class="flaticon2-information text-warning"></i>
                Usted puede asociar un link a esta asignación introduciendo el
                url aquí (opcional)
              </span>
            </div>
          </div>
          ...
          <div class="form-group row form-element">
            <div
              class="col-xl-3 col-lg-3 col-md-3 col-form-label text-md-right"
            >
              <label for="weight"> Porcentaje sobre el 100% de Tareas </label>
            </div>
            <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic">
              <input
                type="text"
              ...
              <span class="form-text text-muted">
                ...
                ponderación a cada Tarea, entonces en este campo debe colocar
                <strong>25</strong> ya que cada Tarea tendrá el 25% de la nota
                de Tareas.
              </span>
            </div>
          </div>
          ...
          <div class="form-group row form-element">
            ...
            <div class="col-lg-9 col-xl-9 col-md-9">
              ...
              <span class="form-text text-muted">
                <i class="flaticon2-information text-warning"></i>
                Haga click aquí si desea agregar esta asignación a varias clases
                o secciones
              </span>
            </div>
          </div>
...
export default {
  name: "modalCrearAsignacion",
  components: {},
  props: ["model", "selectedModal", "action"],
  data() {
    return {
      modeloAsignacion: this.model
    };
  },
  computed: {
  ...
  methods: {
    handleOk() {
      if (this.action == "Agregar") {
        let miModelo = { ...this.modeloAsignacion };
        this.$emit("addedItem", { modelo: miModelo });
      }
      ...
      this.$emit("cleanModel", {});
    }
  },
  mounted() {
    console.log(this.modeloAsignacion);
