  ...
  <div class="topbar-item">
    ...
    >
      <div class="d-flex flex-column text-right">
        <span
          class="text-dark opacity-70 font-weight-bold font-size-base d-none d-md-inline mr-1"
        >
          Bienvenido/a
        </span>
        <span
          class="text-dark opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4"
        >
          Sean
        </span>
      </div>
      <span class="symbol symbol-35">
        <span
          class="symbol-label text-dark font-size-h5 font-weight-bold bg-white-o-30"
        >
          S
        </span>
      </span>
