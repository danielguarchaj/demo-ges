...
<template>
  <div>
    ...
    <div>
          ...
          <div class="row justify-content-center">
            <div class="col-xl-9">
              <div class="form-group row form-element">
                <div class="col-xl-3 col-lg-3 col-md-3 col-form-label text-md-right">
                  <label for="task_name">Título:
                    <span class="form-required-mark">*</span>
                  </label>
                </div>
                <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic">
                  <input type="text" name="task_name" id="task_name" class="form-control form-control-lg" size="30"
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic">
                  <div class="custom-file">
                    <input type="file" name="upload_file" id="upload_file"
                      class="custom-file-input form-control form-control-lg" size="30" />
                    <label class="custom-file-label" for="upload_file">Ningún archivo seleccionado</label>
                  </div>
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic">
                  <input type="text" name="url" value="http://" id="url" class="form-control form-control-lg" />
                  <span class="form-text text-muted">
                    <i class="flaticon2-information text-warning"></i>
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic richtext">
                  <textarea name="description" id="description" cols="50" wrap="soft" rows="7"
                    v-model="modeloAsignacion.descripcion">
                  </textarea>
                  <div class="form-inline">
                    Formato:
                    <select class="form-control" name="description.format" id="description.format">
                      <option value="text/enhanced">Texto enriquecido</option>
                      <option value="text/plain">Texto plano</option>
                      <option value="text/fixed-width">Texto de ancho fijo</option>
                      <option value="text/html">HTML</option>
                    </select>
                    Corrección ortográfica:
                    <select class="form-control" name="description.spellcheck" id="description.spellcheck">
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-date-metronic">
                  ...
                  <input type="hidden" name="available_date.format" value="DD-MM-YYYY" />
                  <select name="available_date.day" id="available_date.day"
                  ...
                  </select>-<select name="available_date.month" id="available_date.month"
                    ...
                    <option value="12">12</option>
                  </select>-<input type="text" name="available_date.year" id="available_date.year" size="4"
                    maxlength="4" value="2020" v-model="modeloAsignacion.anio_disponibilidad" />
                  ...
                  <span class="icon icon-dark icon-2x ges-dd-mm-yy" data-id="available_date">
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-date-metronic">
                  ...
                  <select name="date.day" id="date.day" v-model="modeloAsignacion.dia_entrega">
                    <option value="">--</option>
                    <option value="1">01</option>
                    <option value="2">02</option>
                    ...
                    <option value="30">30</option>
                    <option value="31">31</option>
                  </select>-<select name="date.month" id="date.month" v-model="modeloAsignacion.mes_entrega">
                    <option value="">--</option>
                    <option value="1">01</option>
                    <option value="2">02</option>
                    <option value="3">03</option>
                  ...
                  </select>-<input type="text" name="date.year" id="date.year" size="4" maxlength="4" value="2020"
                  ...
                  <input type="button"
                    ...
                    onclick="return showCalendarWithDateWidget('date', 'y-m-d');" />
                  <b>[DD-MM-YYYY</b>]
                  <span class="icon icon-dark icon-2x ges-dd-mm-yy" data-id="date">
                    <i class="flaticon-event-calendar-symbol"></i>
                  </span>
                </div>
              </div>
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-date-metronic">
                  <!-- date due_date begin -->
                  <input type="hidden" name="due_date.format" value="HH24:MI:SS" />
                  ...
                  </select>:<select name="due_date.seconds" id="due_date.seconds">
                    <option value="">--</option>
                    <option value="0">00</option>
                    <option value="5">05</option>
                    <option value="10">10</option>
                  ...
                  [HH24:MI:SS]
                  <span class="icon icon-dark icon-2x ges-hh-ii-ss" data-id="due_date">
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-2 col-xl-2 col-md-2 ges-form-metronic">
                  <input type="text" name="number_of_members" value="1" id="number_of_members"
                    class="form-control form-control-lg" size="5" v-model="modeloAsignacion.numero_personas" />
                  <span class="form-text text-muted">
                    <i class="flaticon2-information text-warning"></i>
                    Individual = 1
                  </span>
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic">
                  <input type="text" name="weight" value="0" id="weight" class="form-control form-control-lg w-25"
                    size="5" v-model="modeloAsignacion.valor.porcentaje" />
                  <span class="form-text text-muted">
                    <i class="flaticon2-information text-warning"></i>
                ...
                <div class="col-lg-9 col-xl-9 col-md-9">
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:online_p:t">
                      <input type="radio" name="online_p" value="t" id="task:elements:online_p:t" checked="checked"
                  ...
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:online_p:f">
                      <input type="radio" name="online_p" value="f" id="task:elements:online_p:f"
                        v-model="modeloAsignacion.envio_electronico" />
                      <span></span>
                      No
                    </label>
                ...
                <div class="col-lg-9 col-xl-9 col-md-9">
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:late_submit_p:t">
                      <input type="radio" name="late_submit_p" value="t" id="task:elements:late_submit_p:t"
                        checked="checked" v-model="modeloAsignacion.entrega_retrasada" />
                      <span></span>
                      Sí
                    </label>
                  </div>
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:late_submit_p:f">
                      <input type="radio" name="late_submit_p" value="f" id="task:elements:late_submit_p:f"
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9">
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:requires_grade_p:t">
                      <input type="radio" name="requires_grade_p" value="t" id="task:elements:requires_grade_p:t"
                        checked="checked" v-model="modeloAsignacion.tendra_nota" />
                      <span></span>
                      Sí
                    </label>
                  </div>
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:requires_grade_p:f">
                      <input type="radio" name="requires_grade_p" value="f" id="task:elements:requires_grade_p:f"
                ...
                <div class="col-lg-9 col-xl-9 col-md-9">
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:use_forums:t">
                      <input type="radio" name="use_forums" value="t" id="task:elements:use_forums:t"
                  ...
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:use_forums:f">
                      <input type="radio" name="use_forums" value="f" id="task:elements:use_forums:f" checked="checked"
                        v-model="modeloAsignacion.usara_foros" />
                      <span></span>
                      No
                    </label>
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9">
                  <div class="checkbox-inline">
                    <label class="checkbox" for="task:elements:add_to_more_classes_p:t">
                      <input type="checkbox" name="add_to_more_classes_p" value="t"
                        id="task:elements:add_to_more_classes_p:t" v-model="modeloAsignacion.asignacion_clases" />
                      <span></span>
                      &nbsp;
                    </label>
                  </div>
      ...
      <b-modal id="modal-subir-solucion" size="xl" title="Agregar Tarea Solución A la Tarea">
        <template>
          <p>
          ...
          <div class="row justify-content-center">
            <div class="col-xl-9">
                  ...
                  <div class="custom-file">
                    <div class="upload-box">
                      <input type="file" name="upload_file" id="upload_file"
                        class="custom-file-input form-control form-control-lg" size="30" />
                      <p class="upload_text">
                        <span class="fa fa-cloud-upload upload-icon"></span><br />Arrastre sus archivos aquí o haga clic
                        en esta
                        área.
                      </p>
                    </div>
              ...
              <div class="form-group row form-element">
                ...
                <div class="col-lg-9 col-xl-9 col-md-9 ges-form-metronic">
                  <input type="text" name="url" value="" id="url" class="form-control form-control-lg"
                    placeholder="http://" />
                </div>
              </div>
            </div>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="d-flex flex-row">
              ...
              <button type="button" class="btn btn-secondary btn-sm text-dark mr-1">
            ...
            <div>
              <div class="d-flex flex-row mt-5 justify-content-between">
                ...
                <div class="actions-container">
                  <button type="button" class="btn btn-light-primary btn-sm mr-1 text-primary text-hover-white"
                    v-b-modal.modal-agregar-tarea @click="selectModal('Tarea', 'tareas', 'Agregar')">
                  ...
                  <button type="button" class="btn btn-light-primary text-primary btn-sm">
                    <i class="py-0 fa fa-bars"></i>
                  </button>
                </div>
              </div>
              <Table :fields="fields" :items="allTareas" tipoAsignacion="tareas" @deleteItem="handleDeletedItem"
                @editRecord="handleEditRecord"></Table>
            </div>
            <div class="actions-container">
              <div class="d-flex flex-row mt-5 justify-content-between">
                <div class="d-flex flex-row">
                ...
                <div>
                  <button type="button" class="btn btn-light-primary text-primary text-hover-white btn-sm mr-1"
                    v-b-modal.modal-agregar-tarea @click="selectModal('Proyecto', 'proyectos', 'Agregar')">
                    <i class="py-0 fa fa-plus"></i>
                    Agregar
                  </button>
                  <button type="button" class="btn btn-light-primary text-primary btn-sm mr-1 text-hover-white">
                    <i class="py-0 fa fa-trash-alt text-danger"></i>
                    Eliminar
                  </button>
              ...
              <Table :fields="fields" :items="allProyectos" tipoAsignacion="proyectos" @deleteItem="handleDeletedItem"
                @editRecord="handleEditRecord"></Table>
            </div>
            <div>
              <div class="d-flex flex-row mt-5 justify-content-between">
                ...
                <div class="actions-container">
                  <button type="button" class="btn btn-light-primary text-primary text-hover-white btn-sm mr-1"
                    v-b-modal.modal-agregar-tarea @click="selectModal('Examen Final', 'finales', 'Agregar')">
                    <i class="py-0 fa fa-plus"></i>
                    Agregar
                  </button>
                  <button type="button" class="btn btn-light-primary text-primary btn-sm mr-1 text-hover-white">
              ...
              <Table :fields="fields" :items="allFinales" tipoAsignacion="finales" @deleteItem="handleDeletedItem"
                @editRecord="handleEditRecord"></Table>
            </div>
            <div>
              <div class="d-flex flex-row mt-5 justify-content-between">
                ...
                <div class="actions-container">
                  <button type="button" class="btn btn-light-primary text-primary text-hover-white btn-sm mr-1"
                    v-b-modal.modal-agregar-tarea @click="
              ...
              <Table :fields="fields" :items="allParciales" tipoAsignacion="parciales" @deleteItem="handleDeletedItem"
                @editRecord="handleEditRecord"></Table>
            </div>
          </div>
        </div>
